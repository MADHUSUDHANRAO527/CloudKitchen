...
class KitchensAdapter(private val mContext: Context, private var kitchensList: ArrayList<KitchensModel>) :
    RecyclerView.Adapter<KitchensAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.kitchenTitle.text = kitchensList[position].title
